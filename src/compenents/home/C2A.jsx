...
const C2A = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-5 mt-10">
      <div className="hidden flex-col-reverse md:mr-20 md:h-[35rem] md:w-[50rem] md:flex md:flex-col">
        <img src={c2a[0]} className="md:h-[41rem] "></img>
      </div>
      <div className="my-2 w-[20rem] md:w-[25rem] md:mr-50">
      ...
      <div className="flex flex-col md:hidden mb-15">
        <img src={c2a[0]} className=" w-[25rem]"></img>
      </div>
    </div>
  );
};
