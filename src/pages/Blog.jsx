...
function Blog() {
  return (
    <div className="blog">
      <HeaderShop />
      <div className="w-full flex flex-col justify-center items-center gap-8 md:mt-5 ">
        <div className="w-[20rem] md:w-[30rem] ">
          <h6 className="text-center text-[#23a6f0]">Practice Advice</h6>
          <h2 className=" md:w-[25rem] font-bold text-black text-center">
            Featured Posts
          </h2>
          <p className="md:w-[29rem] ">
